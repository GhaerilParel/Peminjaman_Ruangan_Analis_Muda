...
<script>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <script>
                                        document.querySelector("form[action='{{ route('booking.store') }}']").addEventListener("submit", function(event) {
                                            ...
                                            const mulaiJam = parseInt(waktuMulai.split(":")[0]);
                                            const selesaiJam = parseInt(waktuSelesai.split(":")[0]);

                                            // Validasi waktu (antara jam 6 pagi hingga 8 malam)
                                            if (mulaiJam < 6 || selesaiJam > 20) {
    ...
    <div class="modal fade" id="infoModal" tabindex="-1" aria-labelledby="infoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg border-0 info-modal">
                <div class="modal-body text-center">
                    <div class="info-icon">&#128197;</div> <!-- Ikon kalender -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Fungsi untuk menampilkan modal dengan informasi booking
            ...
            // Contoh data booking (ganti dengan data dari API)
            const bookedDates = [{
                    date: "2025-05-10",
                    bookings: [{
                            nama: "John Doe",
            ...
            // Tambahkan event listener untuk setiap tanggal di kalender
            calendarDates.addEventListener("click", function(event) {
                const clickedDate = event.target.getAttribute("data-date");
                if (clickedDate) {
                    const bookedInfo = bookedDates.find(booked => booked.date === clickedDate);
                    if (bookedInfo) {
                        showBookingInfo(bookedInfo.bookings);
                    }
                }
            });
        });
    ...
    <div class="modal fade" id="infoModal" tabindex="-1" aria-labelledby="infoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg border-0 error-modal">
                <div class="modal-body text-center">
                    <div class="error-icon">&#128197;</div> <!-- Ikon kalender -->
                    <h4 class="mb-3">Informasi Booking</h4>
                    <div id="infoModalBody">
                        <!-- Konten informasi akan diisi melalui JavaScript -->
                    </div>
    ...
    <div class="modal fade animate__animated animate__fadeInDown" id="timeWarningModal" tabindex="-1"
        aria-labelledby="timeWarningModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg border-0 error-modal">
                <div class="modal-body text-center">
                    <div class="error-icon">&#9888;</div> <!-- Ikon peringatan -->
                    <h4 class="mb-3">Peringatan Waktu</h4>
                    <p class="mb-4">Waktu peminjaman harus antara jam 6 pagi hingga jam 8 malam. Silakan sesuaikan
                        waktu Anda.</p>
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Tutup</button>
                </div>
            </div>
    ...
    <script>
        document.getElementById('next-button').addEventListener('click', function() {
            // Hapus log error ketika tombol "Selanjutnya" diklik
    ...
    <!-- Modal untuk login -->
    <!-- Modal untuk login -->
    <div class="modal fade animate__animated animate__fadeInDown" id="loginModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg border-0 error-modal">
                <div class="modal-body text-center">
                    ...
                    <p class="mb-4">Untuk melanjutkan ke halaman berikutnya, silakan login terlebih dahulu dengan
                        email dan kata sandi yang valid.</p>
