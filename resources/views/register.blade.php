...
<html lang="en">
    ...
    <div class="mb-3">
        <div class="form-floating">
            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" required placeholder="Fullname" value="{{ old('name') }}">
    ...
    <div class="mb-3">
        <div class="form-floating">
            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" required placeholder="name@example.com" value="{{ old('email') }}">
    ...
    <div class="form-floating">
        ...
        <small id="passwordHelp" class="text-danger d-none">Minimal 8 karakter, mengandung huruf besar, huruf kecil, dan angka.</small>
        <small id="passwordSuccess" class="text-success d-none">✅ Password sudah sesuai!</small>
    </div>
</div>
